...
if ( ! class_exists( 'EMD_Meta_Box' ) )
{
	...
	class EMD_Meta_Box
	{
		...
		{
			$jqvalid_msg['required'] = __('This field is required.','campus-directory');
			$jqvalid_msg['remote'] = __('Please fix this field.','campus-directory');
			$jqvalid_msg['email'] = __('Please enter a valid email address.','campus-directory');
			$jqvalid_msg['url'] = __('Please enter a valid URL.','campus-directory');
			$jqvalid_msg['date'] = __('Please enter a valid date.','campus-directory');
			$jqvalid_msg['dateISO'] = __('Please enter a valid date ( ISO )','campus-directory');
			$jqvalid_msg['number'] = __('Please enter a valid number.','campus-directory');
			$jqvalid_msg['digits']= __('Please enter only digits.','campus-directory');
			$jqvalid_msg['creditcard']= __('Please enter a valid credit card number.','campus-directory');
			$jqvalid_msg['equalTo']= __('Please enter the same value again.','campus-directory');
			$jqvalid_msg['maxlength']= __('Please enter no more than {0} characters.','campus-directory');
			$jqvalid_msg['minlength']= __('Please enter at least {0} characters.','campus-directory');
			$jqvalid_msg['rangelength']= __('Please enter a value between {0} and {1} characters long.','campus-directory');
			$jqvalid_msg['range']= __('Please enter a value between {0} and {1}.','campus-directory');
			$jqvalid_msg['max']= __('Please enter a value less than or equal to {0}.','campus-directory');
			$jqvalid_msg['min']= __('Please enter a value greater than or equal to {0}.','campus-directory');
		...
		function show()
		{
			...
			if(isset( $this->validation ) && $this->validation){
				echo '
					...
					summaryMessage : "' . __( 'Please correct the errors highlighted below and try again.', 'campus-directory' ) . '",';
			}
