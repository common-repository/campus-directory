...
class P2P_Box {
	...
	public function init_scripts() {
		...
		wp_localize_script( 'p2p-box', 'P2PAdmin', array(
			...
			'deleteConfirmMessage' => __( 'Are you sure you want to delete all connections?', 'campus-directory' ),
	...
	protected function render_create_connections( $post ) {
		...
		$data['tabs'][] = array(
			'tab-id' => 'search',
			'tab-title' => __( 'Search', 'campus-directory' ),
	...
	protected function post_rows( $current_post_id, $page = 1, $search = '' ) {
		...
		if ( $candidate->total_pages > 1 ) {
			$data['navigation'] = array(
				...
				'prev-label' =>  __( 'previous', 'campus-directory' ),
				'next-label' =>  __( 'next', 'campus-directory' ),
				'of-label' => __( 'of', 'campus-directory' ),
			);
		}
