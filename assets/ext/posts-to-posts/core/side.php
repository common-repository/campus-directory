...
class P2P_Side_User extends P2P_Side {
	...
	function get_desc() {
		return __( 'Users', 'campus-directory' );
	}
	...
	function get_labels() {
		return (object) array(
			'singular_name' => __( 'User', 'campus-directory' ),
			'search_items' => __( 'Search Users', 'campus-directory' ),
			'not_found' => __( 'No users found.', 'campus-directory' ),
		);
	}
