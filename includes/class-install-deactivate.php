...
<div class="updated">
<?php
				printf('<p><a href="%1s" target="_blank"> %2$s </a>%3$s<a style="float:right;" href="%4$s"><span class="dashicons dashicons-dismiss" style="font-size:15px;"></span>%5$s</a></p>', 'https://emdplugins.com/plugins/campus-directory-wordpress-plugin?pk_campaign=campus-directory&amp;pk_source=plugin&amp;pk_medium=link&amp;pk_content=notice', __('Upgrade to Professional Version Now!', 'campus-directory') , __('&#187;', 'campus-directory') , esc_url(add_query_arg($this->option_name . '_adm_notice2', true)) , __('Dismiss', 'campus-directory'));
?>
</div>
<?php
			}
			if (current_user_can('manage_options') && get_option($this->option_name . '_setup_pages') == 1) {
				echo "<div id=\"message\" class=\"updated\"><p><strong>" . esc_html__('Welcome to Campus Directory', 'campus-directory') . "</strong></p>
