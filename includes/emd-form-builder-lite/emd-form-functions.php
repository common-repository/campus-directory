	...
	elseif($fields['shc'] == 'adv_table'){
		if($type == 'header'){
			...
			if($fields['adv_table']['adv_show_export']){
				...
				<li data-type="">
				<a href="#"><i class="fa fa-fw fa-check"></i>' . __('Current Page', 'campus-directory') . '</a>
				</li>
				<li data-type="all">
				<a href="#"><i class="fa fa-fw"></i>' . __('All', 'campus-directory') . '</a>
				</li>
				<li data-type="selected">
				<a href="#"><i class="fa fa-fw"></i>' . __('Selected', 'campus-directory') . '</a>
				</li>
				</ul>';
			}
			$ret .= '</div>
