...
?>
<div id="tax-emd-person-<?php echo get_the_ID(); ?>" class="emd-container emd-person-wrap tax-wrap">
<?php $is_editable = 0; ?>
<div class="archive-well tax panel emd-person panel-<?php echo emd_get_attr_val('campus_directory', $post->ID, 'emd_person', 'emd_person_type', 'key'); ?>" style="background-color:#FFFFFF">
	<div class="panel-heading">
		<div class="panel-title">
			<a class="archive permalink font-bold" href="<?php echo esc_url(get_permalink()); ?>" title="<?php echo get_the_title(); ?>"><?php echo esc_html(emd_mb_meta('emd_person_fname')); ?>
