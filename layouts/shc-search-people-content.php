...
global $search_people_count;
$ent_attrs = get_option('campus_directory_attr_list'); ?>
<tr>
<td><a href="<?php echo esc_url(get_permalink()); ?>" title="<?php echo esc_html(emd_mb_meta('emd_person_fname')); ?>
...
<td><a title="<?php echo get_the_title(); ?>" href="<?php echo esc_url(get_permalink()); ?>"><?php if (get_post_meta($post->ID, 'emd_person_photo')) {
