...
global $people_grid_count, $people_grid_filter, $people_grid_set_list;
$real_post = $post;
$ent_attrs = get_option('campus_directory_attr_list');
?>
<div class="emdcol col-pics">
<a class="emd-person-link" href="<?php echo esc_url(get_permalink()); ?>" title="<?php echo esc_html(emd_mb_meta('emd_person_fname')); ?>
